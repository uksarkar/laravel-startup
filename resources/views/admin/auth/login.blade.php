...
<head>
    ...
    <title>{{ __("Login") }} | {{ $global->company_name }}</title>

    <!-- Favicon -->
    <link rel="shortcut icon" href="{{ $global->favicon }}">
    <link rel="icon" href="{{ $global->favicon }}" type="image/x-icon">
        ...
        <div class="hk-pg-wrapper hk-auth-wrapper">
            <header class="d-flex justify-content-between align-items-center">
                <a class="d-flex auth-brand" href="#">
                    <img style="max-width: 100px" class="brand-img" src="{{ $global->logo }}" alt="brand" />
                </a>
                        ...
                        <div class="auth-form-wrap py-xl-0 py-50">
                            <div class="auth-form w-xxl-55 w-xl-75 w-sm-90 w-xs-100">
                                <form method="POST" action="{{ route('admin.login') }}">
                                    ...
                                    <button class="btn btn-pink btn-block" type="submit">{{ __('Login') }}</button>
