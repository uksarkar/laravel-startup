                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="hk-legend-wrap mt-20">
                                <div class="hk-legend">
                                    <span class="d-10 bg-pink-light-3 rounded-circle d-inline-block"></span><span>18-24</span>
                                </div>
                                <div class="hk-legend">
                                    <span class="d-10 bg-pink-light-4 rounded-circle d-inline-block"></span><span>25-34</span>
                                </div>
                                <div class="hk-legend">
                                    <span class="d-10 bg-pink-light-5 rounded-circle d-inline-block"></span><span>35-44</span>
                                </div>
                                <div class="hk-legend">
                                    <span class="d-10 bg-pink-light-2 rounded-circle d-inline-block"></span><span>45-54</span>
                                </div>
                                <div class="hk-legend">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="hk-legend-wrap mb-20">
                                <div class="hk-legend">
                                    <span class="d-10 bg-pink-light-4 rounded-circle d-inline-block"></span><span>Sessions</span>
                                </div>
                                <div class="hk-legend">
                                    <span class="d-10 bg-pink-light-3 rounded-circle d-inline-block"></span><span>Pageviews</span>
                                </div>
                            </div>
                        ...
                        <div class="card-body pa-0">
                            <div id="owl_demo_1" class="owl-carousel dots-on-item owl-theme">
                                <div class="fadeOut item img-background overlay-wrap bg-gradient-citrine">
...
@section('page-scripts')
    ...
    <script src="{{ asset('vendors/vectormap/jquery-jvectormap-de-merc.js') }}"></script>
