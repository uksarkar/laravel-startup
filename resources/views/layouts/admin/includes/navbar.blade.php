<nav class="navbar navbar-expand-xl fixed-top hk-navbar navbar-light">
    ...
    <a class="navbar-brand" href="{{ route('admin.dashboard') }}">
        <img style="max-width: 100px;max-height: 100px;" class="brand-img d-inline-block" src="{{ $global->logo }}" alt="brand" />
    </a>
        ...
        <li class="nav-item dropdown dropdown-authentication">
            <a class="nav-link dropdown-toggle no-caret" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="media">
                    <div class="media-img-wrap">
                        <div class="avatar">
                            @if(blank($global->user->image))
                            <span class="avatar-text avatar-text-primary rounded-circle">
                                <span class="initial-wrap">
                                    <span>{{ substr($global->user->name,0,1) }}</span>
                                </span>
                            </span>
                            @else
                            <img src="{{ $global->user->image }}" alt="user" class="avatar-img rounded-circle">
                            @endif
                        </div>
                        <span class="badge badge-success badge-indicator"></span>
                    </div>
                    <div class="media-body">
                        <span>{{ $global->user->name }}<i class="zmdi zmdi-chevron-down"></i></span>
                    </div>
                </div>
            </a>
            <div class="dropdown-menu dropdown-menu-right" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
                ...
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" onclick="document.getElementById('logout-form').submit()" href="#"><i class="dropdown-icon zmdi zmdi-power"></i><span>Log out</span></a>
